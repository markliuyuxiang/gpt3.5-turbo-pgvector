...
const handler = async (req: Request): Promise<Response> => {
  ...
  from the CONTEXT, but never list a URL more than once (ignore trailing forward slashes when comparing uniqueness). Never include URLs that are not in the CONTEXT sections. Never make up URLs`;
